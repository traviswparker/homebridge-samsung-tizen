...
module.exports = class Switch {
    ...
    createService() {
        ...
        this.service = this.service || new Hap.Service.Switch(prefixName + this.accessory.config.name, `switch_${this.accessory.config.identifier}`)
            .setCharacteristic(Hap.Characteristic.ConfiguredName, prefixName + this.accessory.config.name);
    ...
    getValue() {
        ...
        this.service.getCharacteristic(Hap.Characteristic.On).value;
    }
